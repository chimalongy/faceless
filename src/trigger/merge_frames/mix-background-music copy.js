...
//             // Download the background music from URL
...
//                     .input(musicPath)
//                     .complexFilter([
//                         // Loop the music for the full duration of the video
//                         "[1:a]aloop=loop=-1:size=2e+09[looped]",
//                         // Mix original video audio (full volume) with background music (0.25 volume)
...
//             // Upload the final video, overwriting the merged video at the same path
//             logger.log("Uploading final mixed video...");
//             const finalBuffer = fs.readFileSync(outputPath);

//             const { error: uploadError } = await supabase.storage
//                 .from(bucketName)
//                 .upload(upload_destination, finalBuffer, {
